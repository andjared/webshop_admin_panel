    ...
    <tr key={id} className="table-data p-2 align-middle">
      ...
      <td className="table-data p-2">
        <Link href={`/edit/${id}`} className="text-sm z-10">
          <span className="inline-block bg-positive text-white font-medium py-2 px-6 pointer-events-auto">
            Edit
          </span>
        </Link>
      </td>
      <td className="table-data p-2 pointer-events-auto cursor-pointer">
        <span
          className="inline-block bg-warning text-white font-medium py-2 px-6"
